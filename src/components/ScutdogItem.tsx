/**
 * @file ScutdogItem.tsx
 * 
 
 * Name: ScutdogItem.tsx
 * 
 *
...
class ScutdogItem extends React.Component<Props, State>{
   ...
   * @memberof ScutdogItem
   */
  externalLink(resources: any) : JSX.Element {
    return (
...
export default withRouter(ScutdogItem);